...
# create Frame 2 and the controls
...
# create 2 scrolltext objects to display info
content = ScrolledText(root, width = 60, height = 20, bg = "#FFFFDD")
result = ScrolledText(root, width = 60, height = 10, bg = "#DDEEFF")
